...
-- 2 
-- NÃO É POSSIVÉL POIS NÃO EXISTE FORNECEDORES CADASTRADOS
...
SELECT cpf.cliente, funcionario.nome, venda.funcionario_id
FROM cliente, funcionario, venda
WHERE venda.funcionario_id = funcionario_id
AND venda.cliente_id = cliente_id
