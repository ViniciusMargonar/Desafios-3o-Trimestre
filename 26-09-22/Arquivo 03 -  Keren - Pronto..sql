...
SELECT cidade.nome nome_cidade, estado.sigla sigla_do_estado
FROM cidade, estado
...
SELECT cliente.nome nome_do_cliente, cidade.nome cidade -- cidade.id id_cidade
FROM cidade, cliente
...
SELECT cidade.nome cidade, estado.sigla sigla_estado
FROM cidade, estado
WHERE estado.id = cidade.estado_id AND cidade.ativo = 'S';
...
SELECT funcionario.nome nome_do_funcionario, estado.sigla sigla_do_estado
...
SELECT cliente.nome nome_do_cliente, cidade.nome cidade
FROM cliente, cidade
...
SELECT venda.id venda_id, funcionario.nome nome_do_funcionario
